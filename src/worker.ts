...
function cleanupOnFailure(dir: string) {
    if (fs.existsSync(dir)) {
        fs.rmSync(dir, { recursive: true, force: true });
    }
}

function validateMeta(meta: any, entries: AdmZip.IZipEntry[]) {
...
function generateTemplate(entries: AdmZip.IZipEntry[], hash: string, partialMeta: any = {}): string {
